...
interface IUseModelOptionsData {
  // 是否显示供应商名称
  showProvider?: boolean;
}

export const useModelOptionsData = (options?: IUseModelOptionsData) => {
          ...
          .map(model => {
            return {
              label: <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <span style={{ margin: '0 3px' }}> {model.name} {showProvider ? ` (${item.name})` : ''} </span>
