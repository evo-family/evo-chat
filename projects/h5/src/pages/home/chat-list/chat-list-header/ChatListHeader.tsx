...
// todo_lcf 暂时无用 
export const ChatListHeader: FC<IChatListHeaderProps> = ({
  onCollapse,
  onSearch,
  onNewChat,
}) => {
  ...
  return (
    <div className={s.header}>
      ...
      <div className={s.actions}>
        <Tooltip title="搜索">
          <Button className={classNames('evo-button-icon')}
            style={{ color: token.colorTextTertiary }}

            type="text" icon={<EvoIcon size={'small'} type='icon-search' />} onClick={onSearch} />
        </Tooltip>
      </div> */}
