  ...
  return (
    <>
      <SettingGroup title="应用信息">
        ...
        {
          isElectron && <SettingGroup.Item
            title="自动检查更新"
            description="启动时自动检查新版本"
          >
            <Switch checked={about.isAutoUpdate} onChange={(checked) => {
              setAbout({
      ...
      >
        ...
        >
          <Button type="link" href="https://github.com/your-repo/issues" target="_blank">
            提交 Issue
          </Button>
        </SettingGroup.Item>
      </SettingGroup>
