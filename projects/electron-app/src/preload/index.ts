...
import { BaseResult, ElectronAPI, EThemeMode, IAddFileMetaToVectorParams, IAddFilesMetaToVectorParams, IAddFileToVectorParams, IAddFolderToVectorParams, IFileMeta, IGetFileListParams, IKnowledgeMeta, IKnowledgeVectorMeta, IKnowledgeVectorMetaVo, ISearchVectorsByKnowledge, IUploadBufferParams, TAvailableModelMap } from '@evo/types';
...
const __ELECTRON_API__: ElectronAPI = {
  ...
  fileService: {
    ...
    uploadBufferFile: (params: IUploadBufferParams) => ipcRenderer.invoke(IpcChannels.UPLOAD_BUFFER_FILE, params),
  ...
  knowledgeService: {
    ...
    addFileToVector: function (params: IAddFileToVectorParams): Promise<BaseResult<IKnowledgeVectorMeta>> {
    ...
    getVectorsByKnowledgeId: function (knowledgeId: string): Promise<BaseResult<IKnowledgeVectorMetaVo[]>> {
    ...
    addFolderToVector: function (params: IAddFolderToVectorParams): Promise<BaseResult<IKnowledgeVectorMeta[]>> {
      return ipcRenderer.invoke(IpcChannels.KNOWLEDGE_ADD_FOLDER_TO_VECTOR, params);
    },
    addFileMetaToVector: function (params: IAddFileMetaToVectorParams): Promise<BaseResult<IKnowledgeVectorMeta>> {
      return ipcRenderer.invoke(IpcChannels.KNOWLEDGE_ADD_FILE_META_TO_VECTOR, params);
    },
    addFilesMetaToVector: function (parasm: IAddFilesMetaToVectorParams): Promise<BaseResult<IKnowledgeVectorMeta[]>> {
